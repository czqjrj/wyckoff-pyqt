...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="python -m sync", description="多用户校准数据同步")
    sub = parser.add_subparsers(dest="cmd", required=True)
    p_setup = sub.add_parser("setup", help="配置仓库 URL 并 clone")
