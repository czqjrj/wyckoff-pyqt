...
DEFAULT_SETTINGS = {
    ...
    "bt_min_n": 3,
    "bt_cost": 0.004,
    # ── 模拟盘 (auto 筛选/下单/卖出/统计) ──
    # 与 paper/_params.py、settings_keys.DEFAULTS 保持一致; 进入账户同步白名单
    # (SK.Paper), 缺省值必须在此登记, 否则同步 collect 会把缺失键当删除 tombstone
    ...
    "paper_transfer_fee_rate": 0.00001,
    "paper_limit_fill": True,
    "paper_enable_chinext": False,
    "paper_enable_star": False,
    "paper_trailing_stop": True,
    "paper_trail_back_pct": 0.06,
    "paper_trail_activate_pct": 0.0,
    "paper_trail_atr_mult": 0.0,
    "paper_qlib_veto": False,
    "paper_qlib_veto_hi": 0.60,
    "paper_weak_filter": True,
    "paper_weak_max_pos": 1,
    "paper_weak_index_code": "sh000001",
    "paper_va_weight": 0.6,
    ...
    "paper_server_chan_key": "",
    "paper_wechat_corp_id": "",
    "paper_wechat_corp_secret": "",
    "paper_wechat_agent_id": "",
    "paper_wechat_to_user": "",
    ...
    # 分析结论 / AI解读 面板文字字号 (pt)
    "text_font_size": 11,
    # 账户私有数据同步现已全程走 MySQL 云后端 (按登录用户隔离);
    # 以下两个旧 Git 键仅作历史兼容保留, 新版本不再写入 (见 plan_profile_sync.md)
    "profile_repo_url": "",
